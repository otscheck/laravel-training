   ...
   <div class="max-w-md mx-auto bg-gray-100 p-6 mt-12 rounded">
        ...
        <form action="{{route('admin.users.update', $user)}}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" class="block w-full py-3 px-3 mt-2 text-gray-800 appearance-none border-2 border-gray-100
                focus:text-gray-500 focus:outline-none focus:border-gray-200 rounded-md" id="email" name="email" value="{{$user->email}}"/>
                @error('email')
                    <span class="text-sm text-red-400">
                        {{$message}}
                    </span>
            ...
            <div>
                <label for="name">Name</label>
                <select class="block w-full py-3 px-3 mt-2 text-gray-800 appearance-none border-2 border-gray-100
                focus:text-gray-500 focus:outline-none focus:border-gray-200 rounded-md" id="role_id" name="role_id">
